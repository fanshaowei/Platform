package cn.com.chengzi.framework.common.exception;
...
import cn.com.chengzi.framework.common.bean.Response;

/**
 * 全局异常处理
 * @ResponseStatus 注解定义了响应状态码，
 * @ExceptionHandler 注解指定了具体需要拦截的异常类
 * @author fanshaowei
 *
 */
@ControllerAdvice
